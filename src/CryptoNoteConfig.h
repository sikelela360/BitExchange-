...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x404f;  //address starts with "bi"
...
const char     CRYPTONOTE_NAME[]                             = "BitExchange coind";
...
const int      P2P_DEFAULT_PORT                              =49151;
